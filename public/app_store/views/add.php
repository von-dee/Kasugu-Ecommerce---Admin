    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
				...
				&nbsp; &nbsp;
				<button class="btn btn-success-rgba" onclick="$('#pg').val('app_store');$('#view').val('add');$('#class_call').val('add');$('#keys').val('');document.myform.submit();"><i class="feather icon-check-square"></i> &nbsp; Submit</button>
            </div>                        
        </div>
    </div>          
</div>
				...
				<div class="card-body">
					<div>
						<div class="form-group row">
							...
							<div class="col-sm-12">
								<input type="text" class="form-control font-20"  name="productTitle" id="productTitle" placeholder="Title">
							</div>
						</div>                                     
						<div class="form-group row">
							<label for="productTitle" class="col-sm-12 col-form-label">Cost Price</label>
							<div class="col-sm-12">
								<input type="number" class="form-control font-20" name="productCost" id="productCost" placeholder="₵00.00">
							</div>
						</div>      
						<div class="form-group row">
							<label for="productTitle" class="col-sm-12 col-form-label">Sales Price</label>
							<div class="col-sm-12">
								<input type="number" class="form-control font-20" name="productPrice" id="productPrice" placeholder="₵00.00">
							</div>
						</div>      
						<div class="form-group row">
							<label class="col-sm-12 col-form-label">Description</label>
							<div class="col-sm-12">
								<textarea class="form-control font-20" name="productDescription" placeholder="Description" id="productDescription" cols="30" rows="3"></textarea>
							</div>
						</div>
					</div>
				</div>
