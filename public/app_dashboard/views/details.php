...
// var_dump($paging['CHKOUT_ITEMS']); die();
                    ...
                    <div class="col-lg-7 col-xl-8">
                        <div class="card m-b-30">
                            <div class="card-header">                                
                                <div class="row align-items-center">
                                    <div class="col-7">
                                        <h5 class="card-title mb-0">Order No : #<?php echo $paging['CHKOUT_CODE']; ?></h5>
                                    </div>
                            ...
                            <div class="card-body">                                
                                <div class="row mb-5">
                                    <div class="col-md-6 col-lg-6 col-xl-3">
                                        ...
                                        <h6>Order Placed</h6>
                                        <p class="mb-0"><?php echo $paging['CHKOUT_ORDERDATE']; ?> at <?php echo $paging['CHKOUT_ORDERTIME']; ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-3">
                                        <div class="order-primary-detail mb-4">
                                        <h6>Name</h6>
                                        <p class="mb-0"><?php echo $paging['CHKOUT_NAME']; ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-3">
                                        <div class="order-primary-detail mb-4">
                                        <h6>Contact No</h6>
                                        <p class="mb-0">+<?php echo $paging['CHKOUT_PHONE']; ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-3">
                                        <div class="order-primary-detail mb-4">
                                        <h6>Email ID</h6>
                                        <p class="mb-0"><?php echo $paging['CHKOUT_EMAIL']; ?></p>
                                        </div>
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-6 col-lg-6 col-xl-6 ">
                                        ...
                                        <p><?php echo $paging['CHKOUT_LOCATION']; ?></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-6 ">
                                        <div class="order-primary-detail mb-4">
                                        <h6>Billing <a href="#" class="badge badge-primary-inverse">note</a></h6>
                                        <p>₵<?php echo $paging['CHKOUT_ORDERTOTAL']; ?></p>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
                                        ...
                                        <div class="order-total table-responsive ">
                                            <table class="table table-borderless text-right">
                                                <tbody>
                                                    <tr>
                                                        <td>Sub Total :</td>
                                                        <td>₵<?php echo $paging['CHKOUT_SUBTOTAL']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Delivery Cost :</td>
                                                        <td>₵<?php echo $paging['CHKOUT_DELIVERYCOST']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tax(18%) :</td>
                                                        <td>₵00.00</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-black f-w-7 font-18">₵<?php echo $paging['CHKOUT_ORDERTOTAL']; ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <?php if($paging['CHKOUT_STATUS'] == "0"){ ?>
                                            </b> : Request Cancelled </b>
                                        <?php
                                            }else if($paging['CHKOUT_STATUS'] == "1"){
                                        ?>
                                            </b> : Request Pending </b>
                                        <?php
                                            }else if($paging['CHKOUT_STATUS'] == "2"){
                                        ?>
                                            </b> : Request Accepted </b>
                                        <?php
                                            }else if($paging['CHKOUT_STATUS'] == "3"){
                                        ?>
                                            </b> : Request Intransit </b>
                                        <?php
                                            }else if($paging['CHKOUT_STATUS'] == "4"){
                                        ?>
                                            </b> : Request At Destination </b>
                                        <?php
                                            }else if($paging['CHKOUT_STATUS'] == "5"){
                                        ?>
